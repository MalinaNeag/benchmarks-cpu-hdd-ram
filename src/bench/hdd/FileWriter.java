/** This package contains classes for performing benchmarks on
 * the write speed of hard disk drives (HDD).
 */
package bench.hdd;
...
/** This class is responsible for writing files on disk using a variable buffer size and a fixed file size or
 * variable file size and a fixed buffer size.
 */
public class FileWriter {
     ...
     * @throws IOException
     */
    public void streamWriteFixedFileSize(String filePrefix, String fileSuffix, int minIndex, int maxIndex, long fileSize, boolean clean) throws IOException {
        ...
        System.out.println("File write score on partition " + partition + ": " + String.format("%.2f", benchScore) + " MB/sec");
    }
     ...
     *            - size of the benchmark file to be written in the disk
     */
    public void streamWriteFixedBufferSize(String filePrefix, String fileSuffix, int minIndex, int maxIndex, int bufferSize, boolean clean) throws IOException {
    ...
    /** Prints statistics about file writing to the console.
     *
     * @param fileName
     ...
     * @param bufferSize
     *          - the size of the buffer used for writing, in bytes
     */
